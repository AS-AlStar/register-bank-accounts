...
ActiveRecord::Schema.define(version: 20_210_901_173_815) do
  ...
  create_table 'accounts', force: :cascade do |t|
    ...
    t.index %w[user_id currency], name: 'index_accounts_on_user_id_and_currency', unique: true
  end

  create_table 'deposit_events', force: :cascade do |t|
    t.string 'currency', null: false
  ...
  create_table 'events', force: :cascade do |t|
    ...
    t.index %w[eventable_id eventable_type], name: 'index_events_on_eventable_id_and_eventable_type', unique: true
  end
